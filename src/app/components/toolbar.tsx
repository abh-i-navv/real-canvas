...
import { Circle, Minus, MousePointer2, Pencil, Square, Type } from "lucide-react";
...
export const ToolBar = ({canvasState,setCanvasState}: ToolBarProps) => {
    ...
    return(
        <div className="h-10 w-auto border-2 rounded-md absolute left-[50%] top-0 z-10">
            <div className="h-full flex justify-center items-center">
                ...
                <Pencil className={cn("m-5 hover:bg-purple-300", canvasState.mode === CanvasMode.None && canvasState.layerType === LayerType.Pencil &&  "bg-purple-300")} 
                    onClick={() => setCanvasState({mode: CanvasMode.None, layerType: LayerType.Pencil})} 
                />
